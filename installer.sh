...
pip3 install "$TMP_DIR"

# Clean up temporary directory
rm -rf "$TMP_DIR"

# Create a symlink to the installed app in /usr/local/bin
ln -s "$INSTALL_DIR/bin/your-python-app" "/usr/local/bin/your-python-app"

echo "Installation complete. You can now use the 'your-python-app' command."